...
class ISSDataRequest:
    ...
    def get_overhead_pass(cls, city: City) -> CityOverheadTimes:
        """
        Get overhead pass times for a location from the Open Notify API.
        :param city: a City object
        ...
        response = requests.get(ISSDataRequest.OPEN_NOTIFY_OVERHEAD_PASS_URL, params=city_params)
        print("ISSDataRequest for", city.city_name, "with params:", city_params)
